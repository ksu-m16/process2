...
/**
* invoked by class extends ProcessStep - get input to that non-abstract class
*
...
/**
* invoked by ProcessStep class - set output parameters before process runner will take it
*
* @param key, value - output key-value pair generated while step processing
*/
